# -*- coding: utf-8 -*-
"""
Created on Mon Jul 20 16:59:42 2020
...
df.to_excel("new from MCD.xlsx")

# Visualize the data after removing outliers

ax = plt.axes()
ax.scatter(new_data[:,0:1],new_data[:,1:],alpha=0.5)
ax.set(ylabel = 'Gas production rate, MSCF/d',xlabel = 'Production time, day', title = 'Minimum Covariance Determinant algorithm')
